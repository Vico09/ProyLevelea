...
import com.gsvd.levelea.levelea.opportunity.adapter.FeedListAdapter;
import com.gsvd.levelea.levelea.opportunity.app.AppController;
import com.gsvd.levelea.levelea.opportunity.data.FeedItem;
...
public class MainOpportunity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__opportinity);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_main__opportinity, menu);
        return true;
    }
